...
public class GatheringService {
     ...
     * @return
     */
    @Cacheable(value = "gathering", key = "#id") //缓存查询的结果
     ...
     * @param gathering
     */
    @CacheEvict(value = "gathering", key = "#gathering.id") //清除SpringCache中的缓存
     ...
     * @param id
     */
    @CacheEvict(value = "gathering", key = "#id") //清除SpringCache中的缓存
